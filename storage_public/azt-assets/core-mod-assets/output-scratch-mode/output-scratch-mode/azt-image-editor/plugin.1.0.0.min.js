	...
	class h {
		constructor(t, e) {
			(this.editor = t),
				...
				this.pluginApi.loadMultipleScript([{ name: 'mnpaint_bundle.js', url: 'https://239114911.e.cdneverest.net/cdnazota/storage_public/azota_assets/js/mnpaint_bundle.js?v=0.3', mode: o.DOCUMENT }]).then(() => {
