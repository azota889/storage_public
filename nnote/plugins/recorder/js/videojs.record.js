...
var ConvertEngine = function (_Component) {
  ...
  (0, _createClass2.default)(ConvertEngine, [{
    ...
    key: "addFileInfo",
    value:
    function addFileInfo(fileObj, now) {
...
var RecordRTCEngine = function (_RecordEngine) {
  ...
  (0, _createClass2.default)(RecordRTCEngine, [{
    ...
    key: "onStopRecording",
    value:
    function onStopRecording(audioVideoURL, type) {
      var _this = this;
    ...
    key: "onTimeStamp",
    value:
    function onTimeStamp(current, all) {
...
var Record = function (_Plugin) {
  ...
  (0, _createClass2.default)(Record, [{
    ...
    key: "setCurrentTime",
    value:
    function setCurrentTime(currentTime, duration) {
    ...
    key: "drawCanvas",
    value:
    function drawCanvas(canvas, element, width, height) {
    ...
    value:
    function displayVolumeControl(display) {
    ...
    key: "onStreamVisible",
    value:
    function onStreamVisible(event) {
      this.mediaElement.removeEventListener(_event.default.PLAYING, this.streamVisibleCallback);
