    ...
    input.addEventListener("change", function (e) {
      ...
      var done = function(url){
        ...
        jQuery.ajax({url:apiURL, headers: headers, success: function(result){
          ...
          //Header for upload to cloudStorage
          var headers = {'x-amz-acl': 'public-read'};
          if(result['data'].hasOwnProperty('cloudStorageHeaderObjs')){
            var newHeaders = {};
            var cloudStorageHeaderObjs = result['data']['cloudStorageHeaderObjs'];
            for(var cloudStorageHeaderObj of cloudStorageHeaderObjs){
              if(cloudStorageHeaderObj.headerName != undefined && cloudStorageHeaderObj.headerValue){
                newHeaders[cloudStorageHeaderObj.headerName] = cloudStorageHeaderObj.headerValue;
              }
            }
            headers = newHeaders;
          }
          ...
          jQuery.ajax({url: uploadUrl, type: 'PUT', processData: false, contentType: file['type'], headers: headers, data: blob, success: function(result){
