    ...
    class Application {
      constructor(editor, pluginApi) {
        ...
        this.pluginApi.loadMultipleScript([{
            ...
            url: 'https://cdn.jsdelivr.net/gh/azota889/storage_public/azota_assets/js/mnpaint_bundle.js?v=0.3',
      ...
      processCommonImageTag() {
        this.editor.getBody().querySelectorAll('img').forEach(element => {
          element.classList.add('azt-image-editor-manager-that');
        });
      }
      processImageAztTag() {
        this.editor.getBody().querySelectorAll('azt-image').forEach(element => {
          if (element.hasAttribute('processing'))
            return;
