...
.hljs-strong {
    font-weight: 700
}`,b=t=>{var o;o=t,new Promise(e=>{o.on(a,()=>{e(new p(o))})}).then(e=>{e.loadStyle(n+"__default",A,l.ALL),new m(t,e)})};tinymce.PluginManager.add(n,b)}();