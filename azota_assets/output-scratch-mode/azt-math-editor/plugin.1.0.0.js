(function () {
    ...
    class HelperCore {
      ...
      static setupMceElement() {
        ...
        mfe.setOptions({
          fontsDirectory: 'https://azota889.github.io/storage_public/azota_assets/mathlive/fonts',
          soundsDirectory: 'https://azota889.github.io/storage_public/azota_assets/mathlive/sounds',
          defaultMode: 'math'
        });
        return mfe;
      }
    ...
    class Application {
      constructor(editor, pluginApi) {
        ...
        this.pluginApi.loadMultipleScript([
          {
            name: 'tex-mml-chtml',
            url: 'https://cdn.jsdelivr.net/gh/azota889/storage_public/azota_assets/js/tex-mml-chtml/tex-mml-chtml.js',
