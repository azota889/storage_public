...
var MNote_instance=cc.Class.extend({
    ...
    initNote:function(data){
            ...
            // //console.log("initMnote");
               ...
               /* for(var i=0;i<data.pages.length;i++)
                ...
                if(data.point){
                    ...
                    var strMark=data.point.toString();
                    if(strMark=="1000") strMark="Đ"
                    else if(strMark=="1001") strMark="CĐ"
                    else if(strMark=="2000") strMark="HT"
                    else if(strMark=="2001") strMark="CHT"
                    else if(strMark=="3000") strMark="HTT"
     ...
     exportJSON:function(){
        ...
        var strMark=$("#mark_number_txt").val();
        if(strMark.trim()=="Đ") mnotedata.point="1000";
        else if(strMark.trim()=="CĐ") mnotedata.point="1001";
        else if(strMark.trim()=="HT") mnotedata.point="2000";
        else if(strMark.trim()=="CHT") mnotedata.point="2001";
        else mnotedata.point=strMark
    ...
    /** mark */
     updateMark:function(value){
        ...
        if(this.point==1000){
            $("#mark_number_txt").val("Đ");
        }else if(this.point==1001){
            $("#mark_number_txt").val("CĐ");
        }else if(this.point==2000){
            $("#mark_number_txt").val("HT");
        }else if(this.point==2001){
            $("#mark_number_txt").val("CHT");
        }else if(this.point==3000){
            $("#mark_number_txt").val("HTT");
        }else {
     ...
     initMarkUI:function(){
        ...
        var div1=$('<div class="btn-mark-chose"><div data="1000" class="btn-mark-chose-bt  btn-floating waves-effect waves-light" style="background-color:#e0e0e0"><span style="color:#444444">'+'Đ'+'</span></div></div>');
        $("#mnote_mark_chose").append($(div1));
        var div2=$('<div class="btn-mark-chose"><div data="1001" class="btn-mark-chose-bt  btn-floating waves-effect waves-light" style="background-color:#e0e0e0"><span style="color:#444444;left:22px">'+'CĐ'+'</span></div></div>');
        $("#mnote_mark_chose").append($(div2));
        var div3=$('<div class="btn-mark-chose"><div data="2000" class="btn-mark-chose-bt  btn-floating waves-effect waves-light" style="background-color:#e0e0e0"><span style="color:#444444;left:28px">'+'HT'+'</span></div></div>');
        $("#mnote_mark_chose").append($(div3));
        var div4=$('<div class="btn-mark-chose"><div data="2001" class="btn-mark-chose-bt  btn-floating waves-effect waves-light" style="background-color:#e0e0e0"><span style="color:#444444;left:15px;font-size:50px">'+'CHT'+'</span></div></div>');
        $("#mnote_mark_chose").append($(div4));
        var div5=$('<div class="btn-mark-chose"><div data="3000" class="btn-mark-chose-bt  btn-floating waves-effect waves-light" style="background-color:#e0e0e0"><span style="color:#444444;left:15px;font-size:50px">'+'HTT'+'</span></div></div>');
        $("#mnote_mark_chose").append($(div5));
