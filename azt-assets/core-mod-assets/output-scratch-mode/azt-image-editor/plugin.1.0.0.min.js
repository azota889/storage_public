	...
	class h {
		constructor(t, e) {
			(this.editor = t),
				...
				this.pluginApi.loadMultipleScript([{ name: 'mnpaint_bundle.js', url: 'https://nextcdn.azota.vn/cdnazota/azt-assets/core-mod-assets/js/mnpaint_bundle.js?v=0.3', mode: o.DOCUMENT }]).then(() => {
