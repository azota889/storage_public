...
imgsdk.processAnswerSheet= async function(options){
  ...
  //try{
    ...
    const str = imgsdk.waModule.ccall('processAnswerSheet', 'string', ["string","string","string","string"], [path_in,path_out,options.token,options.uid]);
    var arr=str.split("_");
    obj.code=Number(arr[0]);
