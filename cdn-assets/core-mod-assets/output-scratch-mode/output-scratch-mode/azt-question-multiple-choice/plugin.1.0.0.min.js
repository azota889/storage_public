!function(){"use strict";const a="azt-question-multiple-choice",i="azt-dispatch-setup-api",n="azt-dispatch-push-json-content",s="azt-answer-managers";var o,r,e;(e=o=o||{})[e.FRAME=0]="FRAME",e[e.DOCUMENT=1]="DOCUMENT",e[e.ALL=2]="ALL",(e=r=r||{})[e.AztSigma=0]="AztSigma",e[e.AztImage=1]="AztImage",e[e.AztAdd=2]="AztAdd",e[e.AztBadge=3]="AztBadge",e[e.AztLayoutList=4]="AztLayoutList",e[e.AztBraces=5]="AztBraces",e[e.AztListChecks=6]="AztListChecks";const c={setup:(e,n)=>{e.addCommand("aztAddSuggestionActionMenu",(e,t)=>{n.addOneMenu(t)})},call:(e,t)=>{e.execCommand("aztAddSuggestionActionMenu",!1,t)},name:"aztAddSuggestionActionMenu"},t={setup:(e,n)=>{e.addCommand("aztHiddenOneSuggestionActionMenu",(e,t)=>{n.hiddenOneMenu(t)})},call:(e,t)=>{e.execCommand("aztHiddenOneSuggestionActionMenu",!1,t)},name:"aztHiddenOneSuggestionActionMenu"},l={setup:(e,n)=>{e.addCommand("aztOpenOneSuggestionActionMenu",(e,t)=>{n.openOneMenu(t)})},call:(e,t)=>{e.execCommand("aztOpenOneSuggestionActionMenu",!1,t)},name:"aztOpenOneSuggestionActionMenu"},d={setup:(e,n)=>{e.addCommand("aztHiddenSuggestionActionMenu",(e,t)=>{n.hidden(t)})},call:(e,t)=>{e.execCommand("aztHiddenSuggestionActionMenu",!1,t)},name:"aztHiddenSuggestionActionMenu"},u={setup:(e,n)=>{e.addCommand("aztLoadScriptSource",(e,t)=>{n.loadSrcJs(t.name,t.url,t.mode).then(t.callback)})},call:(e,t)=>{e.execCommand("aztLoadScriptSource",!1,t)},name:"aztLoadScriptSource"},p={setup:(e,n)=>{e.addCommand("aztLoadMultipleScriptSource",(e,t)=>{n.loadMultipleSrcJs(t.lst).then(t.callback)})},call:(e,t)=>{e.execCommand("aztLoadMultipleScriptSource",!1,t)},name:"aztLoadMultipleScriptSource"},m={setup:(e,n)=>{e.addCommand("aztLoadStyleSource",(e,t)=>{n.loadStyle(t.name,t.content,t.mode)})},call:(e,t)=>{e.execCommand("aztLoadStyleSource",!1,t)},name:"aztLoadStyleSource"},h={setup:(e,n)=>{e.addCommand("aztSetContentPlaceholderActionMenu",(e,t)=>{n.setContent(t)})},call:(e,t)=>{e.execCommand("aztSetContentPlaceholderActionMenu",!1,t)},name:"aztSetContentPlaceholderActionMenu"};class g{constructor(e){this.editor=e}loadScript(t,n,a){return new Promise(e=>{u.call(this.editor,{name:t,url:n,mode:a,callback:e})})}loadMultipleScript(t){return new Promise(e=>{p.call(this.editor,{lst:t,callback:e})})}loadStyle(e,t,n){return m.call(this.editor,{name:e,content:t,mode:n})}hiddenSuggestionMenu(e){return d.call(this.editor,e)}addOneSuggestionMenu(e,t,n,a,i){return c.call(this.editor,{name:e,callback:t,svgIcon:n,hidden:a,hiddenOnExcuse:i})}openOneSuggestionMenu(e){return l.call(this.editor,e)}hiddenOneSuggestionMenu(e){return t.call(this.editor,e)}setContentPlaceholder(e){return h.call(this.editor,e)}pushJsonContent(e,t){return this.editor.fire(n,{name:e,content:t})}static replaceTranslateService(e){Object.prototype.hasOwnProperty.call(window,"aztEditorFnsTranslateService")||(window.aztEditorFnsTranslateService=e)}translate(e,t){return window.aztEditorFnsTranslateService?window.aztEditorFnsTranslateService(e,t):null!=t?t:e}}class w{constructor(e,t){this.editor=e,this.pluginApi=t,this.startCheckRemove=!1,this.editor.on(n,e=>{"QUESTION_MULTIPLE_CHOICE_JSON"===e.name&&this.processJsonToElement(e.content)}),this.setupEventExport(),t.addOneSuggestionMenu(this.pluginApi.translate("lang_editor_common_add_multiple_choice_question_layout","Thêm layout câu hỏi trắc nghiệm"),"azt-manager-plugins--question-add-multiple-choice",r.AztLayoutList,!1,!0),this.editor.on("keydown",e=>{if("Tab"===e.code){e.preventDefault();e=this.editor.selection.getRng().commonAncestorContainer.parentElement;if("P"===e.tagName&&e.textContent.startsWith("A."))return this.checkExistAnswer()?void 0:(this.createLstAnswers("azt-question-multiple-choice-answers-layout-4",e),this.onHasChoiceTypeQuest());e.closest(".azt-question-answer")&&this.editor.execCommand("mceInsertNewLine")}0===this.editor.getBody().querySelectorAll(".azt-question-multiple-choice-answers").length&&this.onNotHasChoiceTypeQuest()}),this.editor.on("NewBlock",e=>{e=e.newBlock.previousSibling;if(e&&e.tagName&&"P"===e.tagName&&e.textContent.startsWith("A."))return this.createLstAnswers("azt-question-multiple-choice-answers-layout-4",e),this.onHasChoiceTypeQuest();this.recheckElementAnswer()}),this.editor.on("click",e=>{var t=e.target;t.closest&&t.closest(".azt-question-answer")&&e.offsetX<=0&&((e=t.closest(".azt-question-answer")).classList.contains("correct-answer")?(e.classList.remove("correct-answer"),(t=this.editor.getBody().querySelector(`.qv_string_eng_ans[data-index-answer='${e.getAttribute("data-index-answer").replace(".","")}']`))&&t.classList.remove("correct-answer")):(e.classList.add("correct-answer"),(t=this.editor.getBody().querySelector(`.qv_string_eng_ans[data-index-answer='${e.getAttribute("data-index-answer").replace(".","")}']`))&&t.classList.add("correct-answer")))})}createAnswerElement(){var e=document.createElement("ol");return e.classList.add(s),e.classList.add("azt-question-multiple-choice-answers"),e}createLstAnswersFromInput(e){const a=this.createAnswerElement();a.classList.add("azt-question-multiple-choice-answers-layout-4"),e.forEach(e=>{var t,n=document.createElement("li");n.classList.add("azt-question-answer"),n.innerHTML=e.content,e.isTrue&&(n.classList.add("correct-answer"),t=this.editor.getBody().querySelector(`.qv_string_eng_ans[data-index-answer='${e.key}']`))&&t.classList.add("correct-answer"),n.setAttribute("data-index-answer",e.key+"."),a.appendChild(n)}),this.editor.getBody().prepend(a),this.onHasChoiceTypeQuest()}processJsonToElement(e){this.createLstAnswersFromInput(e.answers);var t=document.createElement("p");t.innerHTML=e.content,this.editor.getBody().prepend(t),this.editor.selection.setCursorLocation(t,0)}recheckElementAnswer(){var e=this.editor.getBody().querySelectorAll(".azt-question-multiple-choice-answers .azt-question-answer");e.forEach((e,t)=>{e.setAttribute("data-index-answer",["A","B","C","D","E","F","G","H","I","K","L","M","N"][t]+".")}),e.length&&this.onHasChoiceTypeQuest()}onHasChoiceTypeQuest(){this.startCheckRemove=!0,this.pluginApi.hiddenOneSuggestionMenu("azt-manager-plugins--question-add-multiple-choice"),this.pluginApi.setContentPlaceholder(this.pluginApi.translate("lang_cms_common_open_tool","Gõ [kbd=/] để mở công cụ."))}onNotHasChoiceTypeQuest(){this.startCheckRemove&&(this.pluginApi.setContentPlaceholder(this.pluginApi.translate("lang_cms_common_start_answer_input","Gõ [kbd=/] để mở công cụ. Gõ [kbd=A.] nội dung + [kbd=tab] hoặc [kbd=enter] để bắt đầu nhập đáp án")),this.pluginApi.openOneSuggestionMenu("azt-manager-plugins--question-add-multiple-choice"))}checkExistAnswer(){return 0<this.editor.getBody().querySelectorAll(".azt-question-multiple-choice-answers").length}createLstAnswers(e,t){var n=document.createElement("div"),a=(t.parentNode.insertBefore(n,t),t),i=this.createAnswerElement(),e=(i.classList.add(e),t.innerHTML=t.innerHTML.substring(2),document.createElement("li"));e.classList.add("azt-question-answer"),e.appendChild(t),i.appendChild(e),0<t.textContent.length&&((e=document.createElement("li")).classList.add("azt-question-answer"),(t=document.createElement("p")).innerHTML="<br/>",e.appendChild(t),i.appendChild(e),a=t),n.appendChild(i),this.editor.selection.setCursorLocation(a,0),this.recheckElementAnswer()}setupEventExport(){this.editor.on(a+"--export",e=>{var t=this.editor.getBody().querySelector("."+s),n=class{static getAllContentToTop(e){if(!e)return[];var t=[];let n=e.previousElementSibling;for(;n;)t.unshift(n),n=n.previousElementSibling;return t}}.getAllContentToTop(t),a=[];for(let e=0;e<t.children.length;e++){var i=t.children[e];a.push({content:i.innerHTML,key:i.getAttribute("data-index-answer").replace(".",""),isTrue:i.classList.contains("correct-answer")})}e.callback({content:n.map(e=>e.outerHTML).join(""),answers:a})})}}const z=`.azt-question-multiple-choice-answers {
    padding-left: 16px;
    list-style: none;
    margin: 5px;
    margin-top: 20px;
...
}`,A=t=>{var n;n=t,new Promise(e=>{n.on(i,()=>{e(new g(n))})}).then(e=>{e.loadStyle(a+"__default",z,o.ALL),new w(t,e)})};tinymce.PluginManager.add(a,A)}();